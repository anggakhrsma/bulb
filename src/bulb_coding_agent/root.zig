...
pub const rpc_jsonl = @import("rpc_jsonl.zig");
pub const rpc_mode = @import("rpc_mode.zig");
pub const rpc_runtime_host = @import("rpc_runtime_host.zig");
pub const rpc_types = @import("rpc_types.zig");
...
pub const RpcClientOptions = rpc_client.RpcClientOptions;
pub const RpcEventListener = rpc_client.RpcEventListener;
pub const CloneResult = rpc_client.CloneResult;
pub const RpcMode = rpc_mode.RpcMode;
pub const RpcModeOptions = rpc_mode.RpcModeOptions;
pub const RpcRuntimeHost = rpc_runtime_host.RpcRuntimeHost;
pub const RpcRuntimeHostOptions = rpc_runtime_host.RpcRuntimeHostOptions;
pub const RpcSessionState = rpc_types.RpcSessionState;
pub const RpcQueueMode = rpc_types.QueueMode;
pub const JsonlLineReader = rpc_jsonl.JsonlLineReader;
pub const JsonlLineCallback = rpc_jsonl.JsonlLineCallback;
pub const serializeJsonLineAlloc = rpc_jsonl.serializeJsonLineAlloc;
...
test {
    ...
    _ = @import("json.zig");
    _ = @import("rpc_client.zig");
    _ = @import("rpc_jsonl.zig");
    _ = @import("rpc_mode.zig");
    _ = @import("rpc_runtime_host.zig");
    _ = @import("rpc_types.zig");
