// This file is generated from ../pi/packages/ai/src/image-models.generated.ts.
// Do not edit manually; refresh from the frozen Pi snapshot when syncing image models.

const types = @import("types.zig");

pub const image_model_count = 29;
pub const providers = [_][]const u8{
    "openrouter",
};

pub const image_models = [_]types.ImageModel{
    .{
